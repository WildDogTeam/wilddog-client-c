...
{
    {"wilddog_initWithUrl",                 (Wilddog_Func_T)test_new,               0},
    {"wilddog_destroy",                     (Wilddog_Func_T)test_destroy,           0},
    {"wilddog_auth",                        (Wilddog_Func_T)test_auth,              0},
    {"wilddog_getParent",                   (Wilddog_Func_T)test_getParent,         0},
    {"wilddog_getRoot",                     (Wilddog_Func_T)test_getRoot,           0},
    {"wilddog_getChild",                    (Wilddog_Func_T)test_getChild,          0},
    {"wilddog_getKey",                      (Wilddog_Func_T)test_getKey,            0},
    {"wilddog_getHost",                     (Wilddog_Func_T)test_getHost,           0},
    {"wilddog_getPath",                     (Wilddog_Func_T)test_getPath,           0},
    {"wilddog_goOnline",                    (Wilddog_Func_T)test_goOnline,          0},
    {"wilddog_goOffline",                   (Wilddog_Func_T)test_goOffline,         0},
    {"wilddog_getValue",                    (Wilddog_Func_T)test_query,             0},
    {"wilddog_setValue",                    (Wilddog_Func_T)test_set,               0},
    {"wilddog_push",                        (Wilddog_Func_T)test_push,              0},
    {"wilddog_removeValue",                 (Wilddog_Func_T)test_remove,            0},
    {"wilddog_addObserver",                 (Wilddog_Func_T)test_on,                0},
    {"wilddog_removeObserver",              (Wilddog_Func_T)test_off,               0},
    {"wilddog_onDisconnectSetValue",        (Wilddog_Func_T)test_disconn_set,       0},
    {"wilddog_onDisconnectPush",            (Wilddog_Func_T)test_disconn_push,      0},
    {"wilddog_onDisconnectRemoveValue",     (Wilddog_Func_T)test_disconn_rmv,       0},
    {"wilddog_cancelDisconnectOperations",  (Wilddog_Func_T)test_disconn_cancel,    0},
	{"wilddog_node_createObject",			(Wilddog_Func_T)test_node_createObj,	0},
	{"wilddog_node_createUString", 			(Wilddog_Func_T)test_node_createUstr,	0},
	{"wilddog_node_createBString",			(Wilddog_Func_T)test_node_createBstr,	0},
	{"wilddog_node_createFloat", 			(Wilddog_Func_T)test_node_createFloat,	0},
	{"wilddog_node_createNum",				(Wilddog_Func_T)test_node_createNum,	0},
	{"wilddog_node_createNull",				(Wilddog_Func_T)test_node_createNull,	0},
	{"wilddog_node_createTrue",				(Wilddog_Func_T)test_node_createTrue,	0},
	{"wilddog_node_createFalse",			(Wilddog_Func_T)test_node_createFalse,	0},
	{"wilddog_node_getValue",				(Wilddog_Func_T)test_node_getValue,		0},
	{"wilddog_node_setValue",				(Wilddog_Func_T)test_node_setValue,		0},
	{"wilddog_node_addChild",				(Wilddog_Func_T)test_node_addChild,		0},
	{"wilddog_node_delete",					(Wilddog_Func_T)test_node_delete,		0},
	{"wilddog_node_clone",					(Wilddog_Func_T)test_node_clone,		0},
	{"wilddog_node_find",					(Wilddog_Func_T)test_node_find,			0},
    {NULL, NULL, -1},
};
