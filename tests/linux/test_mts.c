...
#define TEST_MTS_URL	"coap://sky.wilddogio.com"
...
STATIC void thread_main(void *args)
{
	...
	p_node = wilddog_node_createUString((Wilddog_Str_T *)TEST_MTS_SETKEY,(Wilddog_Str_T *)TEST_MTS_SETVALUE);
	...
	if(
		...
		wilddog_addObserver( p_client->wd_client,WD_ET_VALUECHANGE, \
			...
			p_client->offrequest_flag = TEST_TRUE;
