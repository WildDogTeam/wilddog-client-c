...
static const char * WD_SYSTEM parse_value(Wilddog_Node_T *item,const char *value);
static const char * WD_SYSTEM skip(const char *in) {while (in && *in && (unsigned char)*in<=32) in++; return in;}
...
static const char *WD_SYSTEM parse_string(Wilddog_Node_T *item,const char *str)
{
...
static const char * WD_SYSTEM parse_number(Wilddog_Node_T *item,const char *num)
{
...
static const char * WD_SYSTEM parse_array(Wilddog_Node_T *item,const char *value)
{
...
static const char * WD_SYSTEM parse_object(Wilddog_Node_T *item,const char *value)
{
	Wilddog_Node_T *child;
