 ...
 */
#define POLARSSL_ECP_WINDOW_SIZE    2 //2   /**< Maximum window size used */   //changed by baikal
 ...
 */
#define POLARSSL_ECP_FIXED_POINT_OPTIM   0 //0  //1     /**< Enable fixed-point speed-up */   //changed by baikal
